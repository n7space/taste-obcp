...
This repository contains a TASTE component that wraps the engine (located in a separate [repository](https://github.com/n7space/n7s-obcp), which is included here as a submodule). The component is ready for (re)use within ESA's [TASTE MBSE Toolchain](https://taste.tools/). The component needs an user provided bridge between the component and the rest of TASTE system to properly handle ASN.1 data types.
