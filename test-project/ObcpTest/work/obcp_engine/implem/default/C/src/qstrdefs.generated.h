...
QDEF1(MP_QSTR_beginstep, 41040, 9, "beginstep")
QDEF1(MP_QSTR_bin, 18656, 3, "bin")
QDEF1(MP_QSTR_bound_method, 41623, 12, "bound_method")
QDEF1(MP_QSTR_cansendpacket, 1117, 13, "cansendpacket")
...
QDEF1(MP_QSTR_endstep, 34264, 7, "endstep")
...
QDEF1(MP_QSTR_getchannelwithpacketavailable, 1539, 29, "getchannelwithpacketavailable")
QDEF1(MP_QSTR_gettime, 13318, 7, "gettime")
QDEF1(MP_QSTR_hex, 20592, 3, "hex")
QDEF1(MP_QSTR_imag, 46919, 4, "imag")
QDEF1(MP_QSTR_isenabled, 58778, 9, "isenabled")
QDEF1(MP_QSTR_ispacketavailable, 30766, 17, "ispacketavailable")
...
QDEF1(MP_QSTR_obcpcontrol, 5276, 11, "obcpcontrol")
QDEF1(MP_QSTR_obcpdatapool, 25143, 12, "obcpdatapool")
QDEF1(MP_QSTR_obcpevents, 38020, 10, "obcpevents")
QDEF1(MP_QSTR_obcpio, 33341, 6, "obcpio")
QDEF1(MP_QSTR_obcppackets, 40320, 11, "obcppackets")
QDEF1(MP_QSTR_obcptime, 63470, 8, "obcptime")
QDEF1(MP_QSTR_oct, 23805, 3, "oct")
QDEF1(MP_QSTR_readboolparameter, 44240, 17, "readboolparameter")
QDEF1(MP_QSTR_readenumparameter, 34381, 17, "readenumparameter")
QDEF1(MP_QSTR_readfloatparameter, 49486, 18, "readfloatparameter")
QDEF1(MP_QSTR_readintparameter, 49485, 16, "readintparameter")
QDEF1(MP_QSTR_real, 63935, 4, "real")
QDEF1(MP_QSTR_receivepacket, 15430, 13, "receivepacket")
QDEF1(MP_QSTR_sendevent, 8373, 9, "sendevent")
QDEF1(MP_QSTR_sendpacket, 40369, 10, "sendpacket")
QDEF1(MP_QSTR_wait, 21902, 4, "wait")
QDEF1(MP_QSTR_waituntil, 55044, 9, "waituntil")
QDEF1(MP_QSTR_writeboolparameter, 7967, 18, "writeboolparameter")
QDEF1(MP_QSTR_writeenumparameter, 15746, 18, "writeenumparameter")
QDEF1(MP_QSTR_writefloatparameter, 1505, 19, "writefloatparameter")
QDEF1(MP_QSTR_writeintparameter, 48610, 17, "writeintparameter")
